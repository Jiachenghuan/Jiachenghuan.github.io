import{r as b,j as n,B as P,F as r,a as f,d}from"./index-hRPrrmI8.js";import{u as w,C as M,T as C,P as A,a as E,b as D,c as B}from"./PropTable-23nQaH-W.js";import{C as z}from"./Customize-VG8lsWKt.js";import{D as S}from"./Dependencies-CnnD7q1S.js";import{B as L}from"./BackgroundContent-BoY4qYJ0.js";import{P as a}from"./PreviewSlider-1xx_yc5I.js";import{P as N}from"./PreviewSelect-6vIg3IHE.js";import{O}from"./OpenInStudioButton-DdrlY0Cc.js";import I from"./PrismaticBurst-g3y1ADkx.js";import"./rotate-ccw-B8KreWeH.js";import"./CodeHighlighter-DU-oquBV.js";import"./PreviewSwitch-BaOPLZui.js";import"./switch-bo4Rr1QZ.js";import"./slider-DRl7Zsjs.js";import"./field-BdbyMjl-.js";import"./Texture-BkQWYNP2.js";const q=`import { useEffect, useRef } from 'react';
...
`,G=`.prismatic-burst-container {
  position: relative;
  width: 100%;
  height: 100%;
  overflow: hidden;
}
`,F=`import { useEffect, useRef } from 'react';
import { Renderer, Program, Mesh, Triangle, Texture } from 'ogl';
...
export default PrismaticBurst;
`,_=`import React, { useEffect, useRef } from 'react';
import { Renderer, Program, Mesh, Triangle, Texture } from 'ogl';
import './PrismaticBurst.css';
...
export default PrismaticBurst;
`,V=`import React, { useEffect, useRef } from 'react';
import { Renderer, Program, Mesh, Triangle, Texture } from 'ogl';
...
export default PrismaticBurst;
`,j={dependencies:"ogl",usage:`import PrismaticBurst from './PrismaticBurst';
...
<div style={{ width: '100%', height: '600px', position: 'relative' }}>
  ...
  />
</div>`,code:q,css:G,tailwind:F,tsCode:_,tsTailwind:V},x={animationType:"rotate3d",intensity:2,speed:.5,distort:0,hoverDampness:.25,rayCount:0,color0:"",color1:"",color2:""},on=()=>{const{props:g,updateProp:t,resetProps:y,hasChanges:R}=w(x),{animationType:o,intensity:i,speed:l,distort:c,hoverDampness:u,rayCount:m,color0:p,color1:v,color2:h}=g,s=[p,v,h].filter(Boolean),T=b.useMemo(()=>[{name:"intensity",type:"number",default:"2",description:"Overall brightness multiplier applied after accumulation."},{name:"speed",type:"number",default:"0.5",description:"Global time multiplier controlling ray motion & distortion."},{name:"animationType",type:'"rotate" | "rotate3d" | "hover"',default:'"rotate3d"',description:"Core motion style: planar rotation, full 3D rotation, or pointer hover orbit"},{name:"colors",type:"string[]",default:"[]",description:"Optional array of hex colors used as a gradient (otherwise spectral)"},{name:"distort",type:"number",default:"0",description:"Amount of bend/distortion applied to marching space (adds organic wobble)"},{name:"paused",type:"boolean",default:"false",description:"Freeze time progression when true (animation stops)"},{name:"offset",type:"{ x?: number|string; y?: number|string }",default:"{ x: 0, y: 0 }",description:"Pixel (or CSS length) offset of focal origin from center"},{name:"hoverDampness",type:"number",default:"0",description:"Smoothing factor (0-1) for pointer tracking when animationType='hover'"},{name:"rayCount",type:"number",default:"undefined",description:"If > 0 applies an angular comb filter to produce discrete ray spokes"},{name:"mixBlendMode",type:"CSSProperties['mixBlendMode'] | 'none'",default:'"lighten"',description:"Canvas CSS mix-blend-mode (e.g. lighten, screen) or 'none' for normal"}],[]);return n.jsx(M,{props:g,defaultProps:x,resetProps:y,hasChanges:R,children:n.jsxs(C,{children:[n.jsxs(A,{children:[n.jsxs(P,{position:"relative",className:"demo-container",h:600,p:0,overflow:"hidden",children:[n.jsx(I,{animationType:o,intensity:i,speed:l,distort:c,hoverDampness:u,rayCount:m||void 0,...s.length?{colors:s}:{}}),n.jsx(L,{pillText:"New Background",headline:"A burst of dancing colors, beautifully unleashed"})]}),n.jsx(r,{justify:"flex-end",mt:2,mb:-2,children:n.jsx(O,{backgroundId:"prismatic-burst",currentProps:{animationType:o,intensity:i,speed:l,distort:c,hoverDampness:u,rayCount:m,colors:s.length?s:void 0},defaultProps:{animationType:"rotate3d",intensity:2,speed:.5,distort:0,hoverDampness:.25,rayCount:0}})}),n.jsxs(z,{children:[n.jsxs(r,{alignItems:"center",gap:4,mb:2,children:[n.jsxs(r,{alignItems:"center",children:[n.jsx(f,{fontSize:"sm",mr:2,children:"Color 1"}),n.jsx(d,{type:"color",value:p,onChange:e=>t("color0",e.target.value),width:"50px",p:0})]}),n.jsxs(r,{alignItems:"center",children:[n.jsx(f,{fontSize:"sm",mr:2,children:"Color 2"}),n.jsx(d,{type:"color",value:v,onChange:e=>t("color1",e.target.value),width:"50px",p:0})]}),n.jsxs(r,{alignItems:"center",children:[n.jsx(f,{fontSize:"sm",mr:2,children:"Color 3"}),n.jsx(d,{type:"color",value:h,onChange:e=>t("color2",e.target.value),width:"50px",p:0})]})]}),n.jsx(N,{title:"Animation Type",options:[{value:"rotate",label:"Rotate"},{value:"rotate3d",label:"Rotate 3D"},{value:"hover",label:"Hover"}],value:o,onChange:e=>t("animationType",e),width:140}),n.jsx(a,{title:"Intensity",min:.1,max:5,step:.1,value:i,onChange:e=>t("intensity",e)}),n.jsx(a,{title:"Speed",min:0,max:2,step:.05,value:l,onChange:e=>t("speed",e)}),n.jsx(a,{title:"Distort",min:0,max:10,step:.1,value:c,onChange:e=>t("distort",e)}),n.jsx(a,{title:"Ray Count",min:0,max:64,step:1,value:m,onChange:e=>t("rayCount",e)}),o==="hover"&&n.jsx(a,{title:"Hover Dampness",min:0,max:1,step:.01,value:u,onChange:e=>t("hoverDampness",e)})]}),n.jsx(E,{data:T}),n.jsx(S,{dependencyList:["ogl"]})]}),n.jsx(D,{children:n.jsx(B,{codeObject:j,componentName:"PrismaticBurst"})})]})})};export{on as default};
